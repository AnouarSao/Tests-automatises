...
public class Tps {
        ...
        static boolean isPrefix(String str1, String str2) {
            /*
             * Test 1: should check if str2 is prefix of str1
             * Test 2: should check if str2 is prefix of str1 while ignoring case
             * Test 3: should check if str2 is prefix of str1 while ignoring case and special characters
             * Test 4:
             **/
        ...
        public static boolean isAnagram(String str1, String str2) {
            ...
            return Arrays.toString(str2Format).equals(Arrays.toString(str1Format));
/*
...
//        String building
        ...
        public static boolean isPalindrom(String str) {
            String formattedStr = str.replaceAll("[^A-Za-z]", "").toLowerCase();
        ...
        public static String capitalze(String str) {
            ...
            String[] strToArr = str.toLowerCase().split("");
